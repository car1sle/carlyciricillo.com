...
<html lang="en">
    ...
    <link rel="stylesheet" href="https://carlyciricillo.com/css/output.css"> <!-- Tailwind output CSS -->
	</head>
  <body class="bg-background-page">
		...
		<main class="w-4/5 sm:w-3/4 mx-auto mt-6 sm:mt-7">
			...
			<p class="font-sans text-text-base text-lg md:text-base mt-2">Head back to <a href="https://carlyciricillo.com/" class="underline text-text-accent">carlyciricillo.com</a> or <a href="https://carlyciricillo.com/" onclick="window.history.go(-1); return false;" class="underline text-text-accent">your&nbsp;previous&nbsp;page</a>.</p>
		</main>
	</body>
</html>