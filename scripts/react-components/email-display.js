  ...
  return (
    <>
      ...
      <div>
        ...
        <p class="text-text-base mb-5 leading-7">One HTML template programmatically adapts to each unique customer. The variation above shows four products that came back in stock, while the variation below spotlights a single carted item at full width. Additionally, Salesforce AMPscript &#40;left unrendered for preview purposes&#41; toggles which Upgrade module will display. Find out how these triggered emails impact Sonos' bottom line in <a href="https://www.wunderkind.co/resources/case-studies/sonos/" target="_blank" class="text-text-accent">the case study</a>!</p>
        <div class="relative w-full overflow-hidden pt-[166.66%] mb-5">
          <iframe
              src={src2}
              title={title2}
