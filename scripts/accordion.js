const emailExamples = {
    "examples": [
        ...
        },
        {
            ...
            "paragraph": `Macy's launched as the highest MRR client on Wunderkind's email product in April 2022. I handled all email design/development requests for this account between onboarding and their 2023 renewal, which they bought into with a 16% price increase. During that first year, Wunderkind drove undeniable revenue for Macy's, with digital campaigns bringing in <b>~$410K+/day</b> & <b>43x return on spend</b>.<sup>2</sup> While working on this account, I standardized the way Wunderkind integrates dynamic <a href="https://movableink.com/platform/email" target="_blank">Movable Ink content</a> through the ESP Responsys.`,
