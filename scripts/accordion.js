const emailExamples = {
    "examples": [
        ...
        },
        {
            ...
            "headline2" : "<b>Spotlight</b>: Abandoned products from Wunderkind x Movable Ink",
            "paragraph": `Macy's launched as the highest paying client on Wunderkind's email product in April 2022. I handled all email design/development requests for this account between onboarding and their 2023 renewal, which they bought into with a 16% price increase. During that first year, Wunderkind drove undeniable revenue for Macy's, with digital campaigns bringing in <b>~$410K+/day</b> & <b>43x return on spend</b>.<sup>2</sup> While working on this account, I standardized the way Wunderkind integrates dynamic <a href="https://movableink.com/platform/email" target="_blank">Movable Ink content</a> through the ESP Responsys.`,
        ...
        },
        {
            ...
            "paragraph": `Wunderkind's triggered emails help Sonos <a href="https://www.wunderkind.co/resources/case-studies/sonos/" target="_blank">solve high onsite abandonment rates</a> by highlighting product quality over discounts. AMPscript logic targets returning customers with credits to upgrade their previous purchases. I led email design/development for a sequence of dynamic Sonos campaigns running across 22 multi-language geos, featuring live text, mobile responsiveness and dark mode media queries for supporting open environments.`,
